    ...
    <div className="text-sm text-[#c8d4e8] space-y-4">
      ...
      {pubTab === "articles" && (
        <>
          ...
          <p>
            A. Nawade et al.<br/>
            <span className="italic">
              Impact of Organic Precursors on Carbon Dots
            </span><br/>
            ChemNanoMat
          </p>
          ...
          <p>
            K. Prakash et al.<br/>
            <span className="italic">
              Single-Crystal Perovskite Halide Devices
            </span><br/>
            Energy Technology
          </p>
          ...
          <p>
            A. Nawade et al.<br/>
            <span className="italic">
              Hybrid Inorganic-Biomolecular Materials
            </span><br/>
            Journal of Electronic Materials
          </p>

          <h3 className="text-[#c9a84c] font-serif mt-6">2024</h3>

          <p>
            K. Ramya, S. Mukhopadhyay<br/>
            <span className="italic">
              Transport models in protein-based molecular junctions
            </span><br/>
            Physica Scripta
          </p>
          ...
          <p>
            C. S. Pathak et al.<br/>
            <span className="italic">
              Conductive CsPbBr₃ Perovskites via Additive Engineering
            </span><br/>
            Energy Advances
          </p>
        </>
      ...
      {pubTab === "patents" && (
        <>
          <h3 className="text-[#c9a84c] font-serif">2026</h3>
          <p>
            A Handheld Ligand-Based Electrochemical Sensing System<br/>
            Ramkumar Kaliyaperumal, Sneigitha Govindarajan, Sabyasachi Mukhopadhyay<br/>
            Indian Patent Publication No: IN202641008527 A1
          </p>

          <h3 className="text-[#c9a84c] font-serif mt-6">2021</h3>
          <p>
            Fiber Material with Moisture Retention & Thermal Tolerance<br/>
            Sreelekha B., Mukhopadhyay S.<br/>
            Indian Patent No. 202141023375
          </p>

          <p>
            PDMS Microchannel-Based Nanoscale Devices<br/>
            Nawade A., Mukhopadhyay S.<br/>
            Indian Patent No. 20214101730A
          </p>
        </>
      )}
      ...
      {pubTab === "books" && (
        <>
          <h3 className="text-[#c9a84c] font-serif">2026</h3>
          <p>
            2D Materials in Chemical Sensing<br/>
            Ramkumar Kaliyaperumal, Ismail A. Akintayo, Sabyasachi Mukhopadhyay<br/>
            CRC Press (ISBN: 9781032944821)
          </p>

          <h3 className="text-[#c9a84c] font-serif mt-6">2020</h3>
          <p>
            Thermochromic Materials for Cool Buildings<br/>
            Nawade A., Ramya K., Mukhopadhyay S.<br/>
            Elsevier
          </p>
        </>
      )}
